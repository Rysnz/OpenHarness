...
use crate::connection_test::json_checker::JsonChecker;
use crate::connection_test::providers::anthropic::AnthropicMessageConverter;
use crate::connection_test::providers::gemini::GeminiMessageConverter;
use crate::connection_test::providers::openai::OpenAIMessageConverter;
use crate::connection_test::proxy::ProxyConfig;
use crate::connection_test::types::*;
use installer_ai_stream::{
...
impl AIClient {
    ...
    fn apply_openai_headers(
        ...
        if self.config.base_url.contains("openopenharness.com") {
            builder = builder.header("X-Verification-Code", "from_openharness");
        }
    ...
    fn apply_anthropic_headers(
        ...
        if url.contains("openopenharness.com") {
            builder = builder.header("X-Verification-Code", "from_openharness");
        }
    ...
    fn unified_usage_to_gemini_usage(usage: installer_ai_stream::UnifiedTokenUsage) -> GeminiUsage {
        GeminiUsage {
...
mod tests {
    use super::AIClient;
    use crate::connection_test::providers::gemini::GeminiMessageConverter;
    use crate::connection_test::types::{AIConfig, ToolDefinition};
    use serde_json::json;
