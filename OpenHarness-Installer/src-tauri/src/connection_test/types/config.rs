//! Copied from `openharness_core::util::types::config` (installer-local; no openharness_core).
...
/// Same rules as `openharness_core::util::types::config::resolve_request_url`.
