...
export function findInstallerThemeById(id: ThemeId): InstallerTheme {
  return THEMES.find((t) => t.id === id)
    ?? THEMES.find((t) => t.id === 'openharness-light')
    ?? THEMES[0];
}
