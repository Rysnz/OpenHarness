...
describe('L1 Settings', () => {
  ...
  describe('Settings panel opening', () => {
    it('settings button should be visible', async function () {
      ...
      const selectors = [
        ...
        '.openharness-header-right button',
        '.openharness-nav-bar__right button',
      ...
      if (!buttonFound) {
        ...
        const headerContainers = [
          '.openharness-header-right',
          '.openharness-nav-bar__right',
          '.openharness-nav-bar__controls',
          '.openharness-nav-bar',
        ];
      ...
      if (!buttonFound) {
        ...
        const header = await $('.openharness-nav-bar, .openharness-header');
    ...
    it('clicking settings button should open panel', async function () {
      ...
      const panel = await $('.openharness-config-center-panel');
  ...
  describe('Settings panel structure', () => {
    ...
    it('settings panel should have content area', async function () {
      ...
      const contentSelectors = [
        '.openharness-config-center-content',
  ...
  describe('Configuration modification', () => {
    it('settings should have form inputs', async function () {
      ...
      const inputs = await browser.$$('.openharness-config-center-panel input, .openharness-config-center-panel select, .openharness-config-center-panel textarea');
  ...
  describe('Settings panel closing', () => {
    it('settings panel should be closable', async function () {
      ...
      const backdrop = await $('.openharness-config-center-backdrop');
