...
export class ChatInput extends BasePage {
  private selectors = {
    container: '[data-testid="chat-input-container"], .openharness-chat-input, .chat-input-container, .chat-input',
    textarea: '.rich-text-input[contenteditable="true"], [data-testid="chat-input-textarea"], .openharness-chat-input [contenteditable="true"], .chat-input textarea, textarea[class*="chat"]',
    sendBtn: '[data-testid="chat-input-send-btn"], button.openharness-chat-input__send-button, button.chat-input__send-btn, button[class*="send"]',
    attachmentBtn: '[data-testid="chat-input-attachment-btn"], .chat-input__attachment-btn',
    cancelBtn: '[data-testid="chat-input-cancel-btn"], .openharness-chat-input__send-button--breathing, .chat-input__cancel-btn, button[class*="cancel"]',
  };
  ...
  private async findTextarea(): Promise<WebdriverIO.Element | null> {
    const selectors = [
      ...
      '.openharness-chat-input__input-area [contenteditable="true"]',
  ...
  async clickSend(): Promise<void> {
    const selectors = [
      ...
      'button.openharness-chat-input__send-button',
