...
# OpenHarness E2E Tests

E2E test framework using WebDriverIO + the embedded OpenHarness WebDriver.
...
The test runner starts OpenHarness directly and waits for the embedded WebDriver service on `127.0.0.1:4445`.
