...
Use this guide to pair OpenHarness through a Feishu bot.
...
Open OpenHarness - Remote Connect - IM Bot - Feishu Bot - Fill in App ID and App Secret - Connect
...
Enter the 6-digit pairing code from OpenHarness Desktop - Send - Connection successful
