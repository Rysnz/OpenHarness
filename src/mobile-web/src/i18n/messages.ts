...
export const messages: Record<MobileLanguage, MessageTree> = {
  'en-US': {
    ...
    sessions: {
      ...
      partnerModeDesc: 'Best for ongoing work with context and personal preferences.',
      partner: 'Partner',
      ...
      partnerSessionDesc: 'Personal partner for daily tasks.',
      recent: 'Recent',
      ...
      remotePartnerSession: 'Remote Partner Session',
      agentCode: 'Code',
      agentCowork: 'Cowork',
      agentPartner: 'Partner',
    ...
    chat: {
      ...
      workingPlaceholder: 'OpenHarness is working...',
      streamingTapToQueue: 'Partner is replying — tap to type a follow-up (queued)',
  ...
  'zh-CN': {
    ...
    sessions: {
      ...
      partnerMode: '伙伴模式',
      partnerModeDesc: '适合持续推进、需要延续上下文和个人偏好的任务。',
      partner: '伙伴',
      defaultPartner: '默认伙伴',
      switchPartner: '切换伙伴',
      selectPartner: '选择伙伴',
      ...
      partnerSession: '伙伴会话',
      partnerSessionDesc: '处理日常任务的个人伙伴。',
      recent: '最近',
      sessionHistory: '会话历史',
    ...
    chat: {
      ...
      workingPlaceholder: 'OpenHarness 正在处理中...',
      streamingTapToQueue: '伙伴正在回复 — 点击输入后续消息（将排队）',
