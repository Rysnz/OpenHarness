...
interface MobileStore {
  ...
  currentPartner: PartnerEntry | null;
  setCurrentPartner: (a: PartnerEntry | null) => void;

  /** One-shot hint after pairing so SessionList matches desktop partner vs project workspace. */
  pairedDisplayMode: 'pro' | 'partner' | null;
  setPairedDisplayMode: (m: 'pro' | 'partner' | null) => void;
...
export const useMobileStore = create<MobileStore>((set, get) => ({
  ...
  currentPartner: null,
  setCurrentPartner: (currentPartner) => set({ currentPartner }),
