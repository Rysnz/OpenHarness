...
const MOBILE_LAST_SELECTED_MODEL_ID_KEY = 'openharness.mobile.last_selected_model_id';
...
function renderStandardGroups(
  ...
  return groups.map((g, gi) => {
    ...
    if (g.type === 'text') {
      const text = g.entries.map(e => e.content || '').join('');
      return text ? (
        <div key={`${keyPrefix}-text-${gi}`} className="chat-msg__partner-content">
          {animate
  ...
  return (
    <div className="chat-page">
      ...
      <div className="chat-page__messages" ref={messagesContainerRef} onScroll={handleScroll}>
        ...
        {(() => {
          // Find the last user message index to determine which partner
          ...
          return messages.map((m, idx) => {
            ...
            if (isOldResponse && !isExpanded) {
              return (
                <div key={m.id} className="chat-msg chat-msg--partner chat-msg--collapsed">
                  <button
            ...
            return (
              <div key={m.id} className="chat-msg chat-msg--partner">
                ...
                {hasItems ? (
                  ...
                  <>
                    ...
                    {m.content && (
                      <div className="chat-msg__partner-content">
            ...
            return (
              <div className="chat-msg chat-msg--partner">
                ...
                {turnIsActive && !turn.thinking && !turn.text && turn.tools.length === 0 && (
                  <div className="chat-msg__partner-content"><TypingDots /></div>
                )}
              </div>
            );
          }
        ...
        {imageAnalyzing && (
          <div className="chat-msg chat-msg--partner">
            <div className="chat-msg__partner-card">
