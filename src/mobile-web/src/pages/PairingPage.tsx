...
const OpenHarnessLogo: React.FC = () => (
  <div className="pairing-page__openharness-logo">
    <svg viewBox="0 0 120 120" role="img" aria-label="OpenHarness">
      <circle className="pairing-page__openharness-logo-wave" cx="60" cy="60" r="34" />
      <g className="pairing-page__openharness-logo-mark">
        <circle cx="60" cy="60" r="34" />
        <line x1="42" y1="36.7" x2="42" y2="83.3" />
        <line x1="78" y1="36.7" x2="78" y2="83.3" />
