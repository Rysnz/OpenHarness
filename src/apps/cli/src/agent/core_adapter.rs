//! Core Agent adapter
//!
//! Adapts openharness-core's Agentic system to CLI's Agent interface
...
use openharness_core::agentic::core::SessionConfig;
use openharness_core::agentic::events::EventQueue;
use openharness_events::{AgenticEvent as CoreEvent, ToolEventData};
