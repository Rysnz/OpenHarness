...
use log::{error, info};
use openharness_core::infrastructure::storage::StorageOptions;
use openharness_core::service::git::{
...
) -> Result<openharness_core::service::git::GitGraph, String> {
    info!(
...
pub async fn git_list_worktrees(
    _state: State<'_, AppState>,
    request: GitRepositoryRequest,
) -> Result<Vec<openharness_core::service::git::GitWorktreeInfo>, String> {
...
) -> Result<openharness_core::service::git::GitWorktreeInfo, String> {
