...
use openharness_core::service::workspace::manager::WorkspaceKind;
...
impl WorkspaceInfoDto {
    pub fn from_workspace_info(
        info: &openharness_core::service::workspace::manager::WorkspaceInfo,
    ) -> Self {
        ...
        Self {
            ...
            partner_id: info.partner_id.clone(),
...
impl WorkspaceIdentityDto {
    pub fn from_workspace_identity(
        identity: &openharness_core::service::workspace::manager::WorkspaceIdentity,
    ) -> Self {
        Self {
...
impl WorkspaceWorktreeInfoDto {
    pub fn from_workspace_worktree_info(
        info: &openharness_core::service::workspace::manager::WorkspaceWorktreeInfo,
    ) -> Self {
        Self {
...
impl WorkspaceTypeDto {
    pub fn from_workspace_type(
        workspace_type: &openharness_core::service::workspace::manager::WorkspaceType,
    ) -> Self {
        use openharness_core::service::workspace::manager::WorkspaceType;
...
impl WorkspaceKindDto {
    pub fn from_workspace_kind(
        workspace_kind: &openharness_core::service::workspace::manager::WorkspaceKind,
    ) -> Self {
        use openharness_core::service::workspace::manager::WorkspaceKind;
        match workspace_kind {
            WorkspaceKind::Normal => WorkspaceKindDto::Normal,
            WorkspaceKind::Partner => WorkspaceKindDto::Partner,
...
impl ProjectStatisticsDto {
    pub fn from_workspace_statistics(
        stats: &openharness_core::service::workspace::manager::WorkspaceStatistics,
    ) -> Self {
        Self {
