...
impl Default for ThemeConfig {
    fn default() -> Self {
        Self::get_builtin_theme("openharness-light").unwrap_or_else(|| Self {
            id: "openharness-light".to_string(),
...
impl ThemeConfig {
    pub fn get_builtin_theme(theme_id: &str) -> Option<Self> {
        match theme_id {
            ...
            "openharness-midnight" => Some(Self {
                id: theme_id.to_string(),
            ...
            "openharness-china-night" => Some(Self {
                id: theme_id.to_string(),
            ...
            "openharness-china-style" => Some(Self {
                id: theme_id.to_string(),
    ...
    fn resolve_builtin_theme_id(theme_id: &str) -> &str {
        if theme_id == "system" {
            return match dark_light::detect() {
                Mode::Dark => "openharness-dark",
                Mode::Light | Mode::Default => "openharness-light",
            };
        }
        theme_id
    }
