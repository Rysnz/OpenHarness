...
//! OpenHarness Desktop - Tauri-based desktop application with TransportAdapter architecture
...
async fn webdriver_bridge_result(request: WebdriverBridgeResultRequest) -> Result<(), String> {
    ...
    openharness_webdriver::handle_bridge_result(request.payload)
}
...
pub async fn run() {
    ...
    eprintln!("=== OpenHarness Desktop Starting ===");

    if let Err(e) = openharness_core::service::config::initialize_global_config().await {
    ...
    // Initialize global I18nService so bot/remote-connect language is always in sync.
    {
        ...
        use openharness_core::service::i18n::initialize_global_i18n_service;
    ...
    let run_result = tauri::Builder::default()
        ...
        .setup(move |app| {
            ...
            openharness_webdriver::maybe_start(app_handle.clone());
            ...
            log::info!("OpenHarness Desktop started successfully");
            Ok(())
        })
        .on_window_event({
                ...
                if let tauri::WindowEvent::CloseRequested { api, .. } = event {
                    if window.label() == "main" {
                            ...
                            .is_ok()
                        {
                            ...
                            openharness_core::util::process_manager::cleanup_all_processes();
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            api::agentic_api::ensure_partner_bootstrap,
            ...
            api::agentic_api::list_agent_tasks,
            api::agentic_api::get_agent_task,
            api::agentic_api::cancel_agent_task,
            api::agentic_api::get_agent_task_events,
            api::agentic_api::get_agent_task_transcript,
            api::agentic_api::get_agent_task_patches,
            api::agentic_api::update_agent_task_patch_status,
            api::agentic_api::apply_agent_task_patch,
            api::agentic_api::reject_agent_task_patch,
            api::agentic_api::merge_agent_task_patches,
            api::agentic_api::get_agent_task_patch_summary,
            api::agentic_api::get_agent_team_status,
            api::agentic_api::send_agent_mailbox_message,
            api::agentic_api::broadcast_agent_team_message,
            api::agentic_api::wait_agent_mailbox_messages,
            api::agentic_api::agent_approval_list_pending,
            ...
            create_partner_workspace,
            delete_partner_workspace,
            reset_partner_workspace,
            close_workspace,
