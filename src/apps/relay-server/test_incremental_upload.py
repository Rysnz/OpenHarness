...
RELAY_URL = sys.argv[1] if len(sys.argv) > 1 else "https://remote.openopenharness.com/relay"
...
async def run_tests():
    ...
    # Test data
    file1_content = "<html><body>Hello OpenHarness Test</body></html>"
    file2_content = "body { margin: 0; background: #1a1a2e; }"
    file3_content = "console.log('OpenHarness incremental upload test');"
