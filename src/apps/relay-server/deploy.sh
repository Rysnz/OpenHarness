#!/usr/bin/env bash
# OpenHarness Relay Server — one-click deploy script.
...
usage() {
  cat <<'EOF'
OpenHarness Relay Server deploy script
...
echo "=== OpenHarness Relay Server Deploy ==="
...
echo ""
echo "Custom Server URL examples for OpenHarness Desktop:"
