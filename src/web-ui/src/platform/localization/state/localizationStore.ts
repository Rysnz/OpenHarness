...
import type { LocaleId, I18nNamespace, I18nState, I18nActions } from '@/platform/localization/types';
import { DEFAULT_LOCALE, DEFAULT_FALLBACK_LOCALE } from '@/platform/localization/presets';
