...
import { OpenHarnessLoading, IconButton } from '@/component-library';
import type { ToolCardProps } from '@/flow_chat/types/flow-chat';
...
export const MCPToolDisplay: React.FC<ToolCardProps> = ({
          ...
          case 'ui/initialize': {
            ...
            const initResult = {
              ...
              result: {
                ...
                hostInfo: { name: 'OpenHarness', version: '1.0.0' },
                hostCapabilities: {
                  openLinks: {},
  ...
  const renderStatusIcon = () => {
    if (isLoading) {
      return <OpenHarnessLoading size="small" />;
    }
    return null;
  };
