...
import type { FlowItem, FlowToolItem, FlowTextItem, FlowThinkingItem } from '@/flow_chat/types/flow-chat';
import type { ExploreGroupData } from '@/flow_chat/store/modernFlowChatStore';
...
import { useToolCardHeightContract } from '@/flow_chat/tool-cards/useToolCardHeightContract';
