...
import type { DialogTurn, FlowTextItem, FlowToolItem, FlowThinkingItem } from '@/flow_chat/types/flow-chat';
    ...
    <div className="export-content">
      <div className="export-content__header">
        ...
        <div className="export-content__title-group">
          <div className="export-content__title">OpenHarness</div>
      ...
      <div className="export-content__footer">
        ...
        <span className="export-content__footer-brand">OpenHarness</span>
        <span>•</span>
        <span>{i18nService.t('flow-chat:exportImage.aiPartner').replace(/ /g, '\u00A0')}</span>
      </div>
    </div>
  );
};
