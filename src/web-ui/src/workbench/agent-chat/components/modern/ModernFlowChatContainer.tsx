...
import { WelcomePanel } from '@/flow_chat/components/WelcomePanel';
...
import { useVirtualItems, useActiveSession, useVisibleTurnInfo, type VisibleTurnInfo } from '@/flow_chat/store/modernFlowChatStore';
import type { FlowChatConfig } from '@/flow_chat/types/flow-chat';
  ...
  useShortcut(
    ...
    () => {
      ...
      const el = root?.querySelector(
        '.openharness-chat-input textarea, .openharness-chat-input [contenteditable="true"]'
      ) as HTMLElement | null;
      el?.focus();
    },
