...
const EditorConfig: React.FC<EditorConfigProps> = () => {
  ...
  if (isLoading) {
    return (
      <ConfigPageLayout className="openharness-editor-config">
        <ConfigPageHeader
          title={t('title')}
          subtitle={t('subtitle')}
        />
  ...
  return (
    <ConfigPageLayout className="openharness-editor-config">
      ...
      <ConfigPageContent className="openharness-editor-config__content">
        <ConfigPageSection
        ...
        >
          <ConfigPageRow label={t('actions.reset')} description={t('messages.confirmReset')} align="center">
            <div className="openharness-editor-config__actions">
              <Button
                variant="secondary"
                size="small"
                onClick={resetConfig}
              ...
              {isSaving && (
                <span className="openharness-editor-config__saving">{t('messages.saving')}</span>
              )}
            </div>
          </ConfigPageRow>
        </ConfigPageSection>
