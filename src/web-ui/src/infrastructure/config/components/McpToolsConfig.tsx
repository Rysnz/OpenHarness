...
const McpToolsConfig: React.FC = () => {
  ...
  const renderServerBadge = (server: MCPServerInfo) => (
    <span className={`openharness-mcp-tools__status-badge ${getStatusClass(server.status)}`}>
  ...
  const renderServerDetails = (server: MCPServerInfo) => {
    ...
    return (
      <div className="openharness-mcp-tools__server-details">
        <div className="openharness-mcp-tools__server-detail-item">
          <span className="openharness-mcp-tools__server-detail-label">
            {tMcp('server.transport')}:
          </span>
          <code className="openharness-mcp-tools__server-detail-value">{server.transport}</code>
        </div>
        {server.statusMessage && (
          <div className="openharness-mcp-tools__server-detail-item">
            ...
            <span className="openharness-mcp-tools__server-detail-value">
              {server.statusMessage}
            </span>
          </div>
        )}
        ...
        {isRemoteServer(server) && (
          <>
            <div className="openharness-mcp-tools__server-detail-item">
              ...
              <code className="openharness-mcp-tools__server-detail-value">
                {server.url || '-'}
              </code>
            </div>
            <div className="openharness-mcp-tools__server-detail-item">
  ...
  return (
    <ConfigPageLayout className="openharness-mcp-tools">
      ...
      <ConfigPageContent>
        ...
        >
          {showJsonEditor && (
            <div className="openharness-mcp-tools__json-editor">
              <div className="openharness-mcp-tools__json-editor-header">
                <h3>{tMcp('jsonEditor.title')}</h3>
                <p className="openharness-mcp-tools__json-hint">{tMcp('jsonEditor.hint1')}</p>
                <p className="openharness-mcp-tools__json-hint">{tMcp('jsonEditor.hint2')}</p>
              </div>
              <Textarea
                ref={jsonEditorRef}
                value={jsonConfig}
                ...
                placeholder={`{\n  "mcpServers": {\n    "server-name": {\n      "command": "npx",\n      "args": ["-y", "@package/name"],\n      "env": {}\n    }\n  }\n}`}
                variant="outlined"
                className="openharness-mcp-tools__json-textarea"
                spellCheck={false}
                error={!!jsonLintError}
                errorMessage={
                  jsonLintError
              ...
              />
              <div className="openharness-mcp-tools__json-actions">
              ...
              <div className="openharness-mcp-tools__json-examples">
                <h4>{tMcp('jsonEditor.exampleTitle')}</h4>
                <div className="openharness-mcp-tools__example">
        ...
        {authDialogServer && (
          <div className="openharness-mcp-tools__json-editor">
            {authDialogServer.oauthEnabled && (
              <>
                <p className="openharness-mcp-tools__json-hint">
