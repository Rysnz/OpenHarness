...
const AIModelConfig: React.FC = () => {
  ...
  if (creationMode === 'selection') {
    return (
      <ConfigPageLayout className="openharness-ai-model-config">
        <ConfigPageHeader
          title={t('providerSelection.title')}
          subtitle={t('providerSelection.subtitle')}
        />

        <ConfigPageContent className="openharness-ai-model-config__content openharness-ai-model-config__content--selection">
          <div className="openharness-ai-model-config__provider-selection">
            
            <Card
              variant="default"
              padding="medium"
              interactive
              className="openharness-ai-model-config__custom-option"
              onClick={handleSelectCustom}
            >
              <div className="openharness-ai-model-config__custom-option-content">
                <Settings size={24} />
                <div>
                  <div className="openharness-ai-model-config__custom-option-title">{t('providerSelection.customTitle')}</div>
                  <div className="openharness-ai-model-config__custom-option-description">{t('providerSelection.customDescription')}</div>
                </div>
              </div>
            </Card>

            
            <div className="openharness-ai-model-config__selection-divider">
              <span>{t('providerSelection.orSelectProvider')}</span>
            </div>

            
            <div className="openharness-ai-model-config__provider-grid">
              {providers.map(provider => (
                <Card
                  ...
                  padding="medium"
                  interactive
                  className="openharness-ai-model-config__provider-card"
                  onClick={() => handleSelectProvider(provider.id)}
                >
                  <div className="openharness-ai-model-config__provider-card-content">
                    <div className="openharness-ai-model-config__provider-name">{provider.name}</div>
                    <div className="openharness-ai-model-config__provider-description">{provider.description}</div>
                    <div className="openharness-ai-model-config__provider-models">
                      {provider.models.slice(0, 3).map(model => (
                        <span key={model} className="openharness-ai-model-config__provider-model-tag">{model}</span>
                      ))}
                      {provider.models.length > 3 && (
                        <span className="openharness-ai-model-config__provider-model-tag openharness-ai-model-config__provider-model-tag--more">
                          +{provider.models.length - 3}
                        </span>
                      )}
                    </div>
                    {provider.helpUrl && (
                      <a
                        ...
                        className="openharness-ai-model-config__provider-help-link"
                        onClick={async (e) => {
                          e.preventDefault();
                          e.stopPropagation();
                          try {
            ...
            <div className="openharness-ai-model-config__selection-actions">
  ...
  const renderEditingForm = () => {
    ...
    const renderModelPickerValue = (option?: SelectOption | SelectOption[]) => {
      ...
      return (
        <span className="select__value openharness-ai-model-config__model-picker-value">
          <span className="select__value-label openharness-ai-model-config__model-picker-value-text">
            {summaryText}
          </span>
        </span>
      );
    ...
    const apiKeySuffix = (
      <button
        type="button"
        className="openharness-ai-model-config__input-visibility-toggle"
    ...
    const renderSelectedModelRows = () => {
      if (selectedModelDrafts.length === 0) {
        return (
          <div className="openharness-ai-model-config__selected-models-empty">
      ...
      return (
        <div className="openharness-ai-model-config__selected-models-list">
          {selectedModelDrafts.map(draft => {
            ...
            return (
              <div key={draft.key} className="openharness-ai-model-config__selected-model-row">
                <div
                  className={[
                    'openharness-ai-model-config__selected-model-head',
                    canToggleExpand && 'openharness-ai-model-config__selected-model-head--toggleable',
                  ].filter(Boolean).join(' ')}
                ...
                >
                  <div className="openharness-ai-model-config__selected-model-head-title">
                    <div className="openharness-ai-model-config__selected-model-head-top">
                      <div className="openharness-ai-model-config__selected-model-toggle">
                        {isExpanded ? <ChevronDown size={14} /> : <ChevronRight size={14} />}
                      </div>
                      <div className="openharness-ai-model-config__selected-model-name">{modelDisplayName}</div>
                    </div>
                    {!editingConfig.id && (
                      <IconButton
                        variant="ghost"
                        size="small"
                        className="openharness-ai-model-config__selected-model-remove"
                        onClick={(e) => {
                          e.stopPropagation();
                  ...
                  {!isExpanded && (
                    <div className="openharness-ai-model-config__selected-model-head-bottom">
                      <span className="openharness-ai-model-config__selected-model-summary">
                        {categoryLabel}
                        {' · '}
                ...
                {isExpanded && (
                  <div className="openharness-ai-model-config__selected-model-grid">
                    <div className="openharness-ai-model-config__selected-model-field">
                      ...
                      <Select
                        ...
                        size="small"
                        className="openharness-ai-model-config__selected-model-category-select"
                        renderValue={(option) => {
    ...
    return (
      <>
        <div className="openharness-ai-model-config__form openharness-ai-model-config__form--modal">
          <div className="openharness-ai-model-config__form-scrollable">
            <ConfigPageSection
              title={isProviderScopedEditing ? t('editProviderSubtitle') : t('editSubtitle')}
              className="openharness-ai-model-config__edit-section"
            >
            {isFromTemplate ? (
              <>
                ...
                <ConfigPageRow label={t('form.baseUrl')} align="center" wide>
                  <div className="openharness-ai-model-config__control-stack">
                    ...
                    {editingConfig.base_url && (
                      <div className="openharness-ai-model-config__resolved-url">
                        <Input
                          value={previewRequestUrl(editingConfig.base_url, editingConfig.provider || 'openai')}
                          readOnly
                          onFocus={(e) => e.target.select()}
                          inputSize="small"
                          className="openharness-ai-model-config__resolved-url-input"
                        />
                      </div>
                    )}
                  </div>
                ...
                <ConfigPageRow label={`${t('form.modelSelection')} *`} wide multiline>
                  <div className="openharness-ai-model-config__control-stack">
                    <div className="openharness-ai-model-config__model-picker-row">
                      <Select
                        ...
                        className={selectedModelValues.length > 0 ? 'openharness-ai-model-config__model-picker-select openharness-ai-model-config__model-picker-select--has-value' : 'openharness-ai-model-config__model-picker-select'}
                      />
                    </div>
                    <div className="openharness-ai-model-config__manual-model-entry">
                      <Input
                    ...
                    {modelFetchHint && (
                      <small className={`resolved-url__hint ${remoteModelsError ? 'openharness-ai-model-config__json-status--error' : ''}`}>
                        {modelFetchHint}
                      </small>
                    )}
            ...
            {showAdvancedSettings && (
              <>
                ...
                <ConfigPageRow label={t('advancedSettings.skipSslVerify.label')} align="center">
                  <div className="openharness-ai-model-config__row-control--stack">
                    ...
                    {editingConfig.skip_ssl_verify && (
                      <div className="openharness-ai-model-config__warning">
                ...
                <ConfigPageRow label={t('advancedSettings.customHeaders.label')} description={t('advancedSettings.customHeaders.hint')} multiline>
                  <div className="openharness-ai-model-config__row-control--stack">
                    <div className="openharness-ai-model-config__header-mode">
                      <label>{t('advancedSettings.customHeaders.modeLabel')}</label>
                      <div>
                        <label className="openharness-ai-model-config__radio-label">
                    ...
                    <div className="openharness-ai-model-config__custom-headers">
                      {Object.entries(editingConfig.custom_headers || {}).map(([key, value], index) => (
                        <div key={index} className="openharness-ai-model-config__header-row">
                          <Input value={key} onChange={(e) => { const nh = { ...editingConfig.custom_headers }; const ov = nh[key]; delete nh[key]; if (e.target.value) nh[e.target.value] = ov; setEditingConfig(prev => ({ ...prev, custom_headers: nh })); }} placeholder={t('advancedSettings.customHeaders.keyPlaceholder')} inputSize="small" className="openharness-ai-model-config__header-key" />
                          <Input value={value} onChange={(e) => { const nh = { ...editingConfig.custom_headers }; nh[key] = e.target.value; setEditingConfig(prev => ({ ...prev, custom_headers: nh })); }} placeholder={t('advancedSettings.customHeaders.valuePlaceholder')} inputSize="small" className="openharness-ai-model-config__header-value" />
                      ...
                      <Button variant="secondary" size="small" onClick={() => setEditingConfig(prev => ({ ...prev, custom_headers: { ...prev?.custom_headers, '': '' } }))} className="openharness-ai-model-config__add-header-btn"><Plus size={14} />{t('advancedSettings.customHeaders.addHeader')}</Button>
                    </div>
                  </div>
                </ConfigPageRow>
                <ConfigPageRow label={t('advancedSettings.customRequestBody.label')} description={t('advancedSettings.customRequestBody.hint')} multiline>
                  <div className="openharness-ai-model-config__row-control--stack">
                    ...
                    {editingConfig.custom_request_body && editingConfig.custom_request_body.trim() !== '' && (() => {
                      try { JSON.parse(editingConfig.custom_request_body); return <small className="openharness-ai-model-config__json-status openharness-ai-model-config__json-status--success">{t('advancedSettings.customRequestBody.validJson')}</small>; }
                      catch { return <small className="openharness-ai-model-config__json-status openharness-ai-model-config__json-status--error">{t('advancedSettings.customRequestBody.invalidJson')}</small>; }
                    })()}
                  </div>
                </ConfigPageRow>
              </>
          ...
          <div className="openharness-ai-model-config__form-actions openharness-ai-model-config__form-actions--sticky">
  ...
  const renderModelCollectionItem = (config: AIModelConfigType) => {
    ...
    const badge = (
      <>
        <span className="openharness-ai-model-config__meta-tag">
          {t(`category.${config.category}`)}
        </span>
        {testResult && (
          <span
            className={`openharness-ai-model-config__status-dot ${testResult.success ? 'is-success' : 'is-error'}`}
    ...
    const details = (
      <div className="openharness-ai-model-config__details">
        <div className="openharness-ai-model-config__details-section">
          <div className="openharness-ai-model-config__details-section-title">
            {t('details.basicInfo')}
          </div>
          <div className="openharness-ai-model-config__details-grid">
            <div className="openharness-ai-model-config__details-item">
              <span className="openharness-ai-model-config__details-label">{t('form.configName')}</span>
              <span className="openharness-ai-model-config__details-value">{providerDisplayName}</span>
            </div>
            <div className="openharness-ai-model-config__details-item">
              <span className="openharness-ai-model-config__details-label">{t('details.modelName')}</span>
              <span className="openharness-ai-model-config__details-value">{config.model_name}</span>
            </div>
            <div className="openharness-ai-model-config__details-item">
              <span className="openharness-ai-model-config__details-label">{t('details.contextWindow')}</span>
              <span className="openharness-ai-model-config__details-value">{config.context_window?.toLocaleString() || '128,000'}</span>
            </div>
            <div className="openharness-ai-model-config__details-item">
              <span className="openharness-ai-model-config__details-label">{t('details.maxOutput')}</span>
              <span className="openharness-ai-model-config__details-value">{config.max_tokens?.toLocaleString() || '-'}</span>
            </div>
            <div className="openharness-ai-model-config__details-item openharness-ai-model-config__details-item--wide">
              <span className="openharness-ai-model-config__details-label">{t('details.apiUrl')}</span>
              <span className="openharness-ai-model-config__details-value">{config.base_url}</span>
            </div>
            {config.capabilities && config.capabilities.length > 0 && (
              <div className="openharness-ai-model-config__details-item openharness-ai-model-config__details-item--wide">
                <span className="openharness-ai-model-config__details-label">{t('details.capabilities')}</span>
                <div className="openharness-ai-model-config__details-tags">
                  {config.capabilities.map(capability => (
                    <span key={capability} className="openharness-ai-model-config__details-tag">
            ...
            {config.description && (
              <div className="openharness-ai-model-config__details-item openharness-ai-model-config__details-item--wide">
                <span className="openharness-ai-model-config__details-label">{t('details.description')}</span>
                <span className="openharness-ai-model-config__details-value openharness-ai-model-config__details-value--text">
                  {config.description}
                </span>
              </div>
            )}
        ...
        {testResult && (
          <div className="openharness-ai-model-config__details-section">
            ...
            <div className={`openharness-ai-model-config__test-result ${testResult.success ? 'success' : 'error'}`}>
              {testResult.message}
            </div>
          </div>
        )}
  ...
  return (
    <ConfigPageLayout className="openharness-ai-model-config">
      ...
      <ConfigPageContent className="openharness-ai-model-config__content">
        ...
        >
          {aiModels.length === 0 ? (
            <div className="openharness-ai-model-config__empty">
              <Wifi size={36} />
            ...
            <div className="openharness-ai-model-config__collection">
              {providerGroups.map(group => (
                <div key={group.providerName} className="openharness-ai-model-config__provider-group">
                  <div className="openharness-ai-model-config__provider-group-header">
                    <div className="openharness-ai-model-config__provider-group-title">
                      <span>{group.providerName}</span>
                      <span className="openharness-ai-model-config__provider-group-count">{group.models.length}</span>
                      <span className="openharness-ai-model-config__meta-tag">
                        {requestFormatLabelMap[group.models[0]?.provider || 'openai'] || (group.models[0]?.provider || 'openai')}
                      </span>
                    </div>
                    <div className="openharness-ai-model-config__provider-group-actions">
                      <IconButton
                        variant="ghost"
                        size="small"
                  ...
                  <div className="openharness-ai-model-config__provider-group-list">
      ...
      <Modal
        ...
        size="xlarge"
        contentClassName="modal__content--fill-flex openharness-ai-model-config__form--modal"
      >
        {renderEditingForm()}
      </Modal>
    </ConfigPageLayout>
