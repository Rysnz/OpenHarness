...
const LSP_SETTINGS_KEY = 'openharness_lsp_settings';
...
const LspConfig: React.FC = () => {
  ...
  return (
    <ConfigPageLayout className="openharness-lsp-config">
      <ConfigPageHeader title={t('title')} subtitle={t('subtitle')} />

      <ConfigPageContent>
        {installMessage && (
          <div className="openharness-lsp-config__message-container">
        ...
        <ConfigPageSection
          ...
          extra={
            <>
              ...
              >
                <RefreshCw size={16} className={isInitializing ? 'openharness-lsp-config__spinning' : ''} />
              </IconButton>
              <IconButton
                variant="ghost"
                size="small"
        ...
        >
          <div className="openharness-lsp-config__plugins">
            <LspPluginList
