...
function BasicsLaunchAtLoginSection() {
  ...
  return (
    <div className="openharness-launch-at-login-config">
      <div className="openharness-launch-at-login-config__content">
...
function BasicsLoggingSection() {
  ...
  return (
    <div className="openharness-logging-config">
      <div className="openharness-logging-config__content">
        <ConfigPageMessage message={message} />
        ...
        >
          <ConfigPageRow
            ...
            align="center"
          >
            <div className="openharness-logging-config__select-wrapper">
              <Select
                value={configLevel}
          ...
          <ConfigPageRow
            ...
            multiline
          >
            <div className="openharness-logging-config__path-row">
              <div className="openharness-logging-config__path-box">
                {runtimeInfo?.sessionLogDir || '-'}
              </div>
              <Tooltip content={t('logging.actions.openFolderTooltip')} placement="top">
                <button
                  type="button"
                  className="openharness-logging-config__open-btn"
...
function BasicsTerminalSection() {
  ...
  const terminalSectionDescription = useMemo(() => {
    ...
    return (
      <>
        {hint}
        <span className="openharness-terminal-config__section-hint-sep"> · </span>
        <span className="openharness-terminal-config__section-hint-extra">
          {t('terminal.recommendations.pwsh.prefix')}{' '}
          <span className="openharness-terminal-config__section-hint-extra-name">
          ...
          <a
            ...
            className="openharness-terminal-config__section-hint-link"
          >
  ...
  return (
    <div className="openharness-terminal-config">
      <div className="openharness-terminal-config__content">
        <ConfigPageMessage message={message} />
        ...
        >
          <ConfigPageRow
            ...
            align="center"
          >
            <div className="openharness-terminal-config__select-wrapper">
              {availableShells.length > 0 ? (
                ...
                <div className="openharness-terminal-config__no-shells">{t('terminal.controls.noShells')}</div>
              )}
            </div>
          </ConfigPageRow>

          {platform === 'windows' && defaultShell === 'Cmd' && (
            <div className="openharness-terminal-config__inline-alert">
...
const BasicsConfig: React.FC = () => {
  ...
  return (
    <ConfigPageLayout className="openharness-basics-config">
      <ConfigPageHeader title={t('title')} subtitle={t('subtitle')} />
      <ConfigPageContent className="openharness-basics-config__content">
