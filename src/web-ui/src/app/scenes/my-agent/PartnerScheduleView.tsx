/**
 * PartnerScheduleView — inline view for managing scheduled jobs of an partner.
 *
...
import './PartnerScheduleView.scss';

const log = createLogger('PartnerScheduleView');
...
export interface PartnerScheduleViewProps {
  workspacePath?: string;
  sessionId?: string;
  partnerName?: string;
}
...
const PartnerScheduleView: React.FC<PartnerScheduleViewProps> = ({
  workspacePath,
  sessionId,
}) => {
...
export default PartnerScheduleView;
