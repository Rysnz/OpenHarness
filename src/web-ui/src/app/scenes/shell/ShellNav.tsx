...
const ShellNav: React.FC = () => {
  ...
  return (
    <div className="openharness-shell-nav">
      <div className="openharness-shell-nav__header">
        <div className="openharness-shell-nav__title-group">
          <span className="openharness-shell-nav__title">{t('nav.shell.title')}</span>
        ...
        <div className="openharness-shell-nav__header-actions" ref={menuRef}>
          <div className={`openharness-shell-nav__split-button${menuOpen ? ' is-active' : ''}`}>
            <Tooltip content={t('nav.shell.actions.newTerminal')} placement="bottom">
              <button
                type="button"
                className="openharness-shell-nav__split-button-main"
            ...
            <Tooltip content={t('actions.more')} placement="bottom">
              <button
                type="button"
                className="openharness-shell-nav__split-button-toggle"
          ...
          {menuOpen ? (
            <div className="openharness-shell-nav__dropdown-menu" role="menu">
              {shellMenuItems.map((shell) => (
                <button
                  key={shell.key}
                  type="button"
                  className="openharness-shell-nav__dropdown-item"
                  role="menuitem"
              ...
              {shellMenuItems.length > 0 ? <div className="openharness-shell-nav__dropdown-separator" /> : null}
              <button type="button" className="openharness-shell-nav__dropdown-item" role="menuitem" onClick={() => { setMenuOpen(false); void handleRefresh(); }}>
                <RefreshCw size={14} />
      ...
      <div className="openharness-shell-nav__view-toggle" role="tablist" aria-label={t('nav.shell.title')}>
        <button
          type="button"
          role="tab"
          className={`openharness-shell-nav__view-toggle-btn${navView === 'manual' ? ' is-active' : ''}`}
        ...
        <button
          type="button"
          role="tab"
          className={`openharness-shell-nav__view-toggle-btn${navView === 'agent' ? ' is-active' : ''}`}
      ...
      <div
        className={`openharness-shell-nav__sections${!hasVisibleContent ? ' openharness-shell-nav__sections--empty' : ''}`}
      >
        {hasVisibleContent ? (
          <div className="openharness-shell-nav__terminal-list">
          ...
          <div className="openharness-shell-nav__empty">
            <p className="openharness-shell-nav__empty-message">
