...
// ── Partner agent token estimates (based on actual prompt files) ─────────────
// partner_mode.md ≈ 838 tok + persona files (BOOTSTRAP/SOUL/USER/IDENTITY) ≈ 600 tok
const PARTNER_SYS_TOKENS = 1438;
...
function buildMockBreakdown(
  ...
  const systemPrompt = PARTNER_SYS_TOKENS;
