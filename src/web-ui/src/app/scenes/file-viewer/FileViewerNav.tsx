...
const FileViewerNav: React.FC = () => {
  ...
  return (
    <div className="openharness-file-viewer-nav">
      <div className="openharness-file-viewer-nav__header">
        <span className="openharness-file-viewer-nav__icon" aria-hidden="true">
          <Folder size={15} />
        </span>
        <span className="openharness-file-viewer-nav__label">
          {t('nav.items.project')}
        </span>
        {currentWorkspace?.rootPath && (
          <span className="openharness-file-viewer-nav__actions">
