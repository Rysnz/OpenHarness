...
const AgentsHomeView: React.FC = () => {
  ...
  return (
    <GalleryLayout className="openharness-agents-scene">
      <GalleryPageHeader
        title={t('page.title')}
      ...
      <div className="gallery-zones">
        ...
        <GalleryZone
          ...
          tools={(
            <>
              <div className="openharness-agents-scene__agent-filters">
                <div className="openharness-agents-scene__agent-filter-group">
                  <span className="openharness-agents-scene__agent-filter-label">
                    {t('filters.source')}
                  </span>
...
const AgentsScene: React.FC = () => {
  ...
  if (page === 'createAgent') {
    return (
      <div className="openharness-agents-scene">
        <CreateAgentPage />
      </div>
    );
  }
