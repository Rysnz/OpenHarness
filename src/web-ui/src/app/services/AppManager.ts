...
export class AppManager implements IAppManager {
  ...
  private clearPersistedPanelState(): void {
    try {
      ...
      localStorage.removeItem('openharness-app-state');
      
      // Clear other potential panel state keys
      localStorage.removeItem('OpenHarness-left-panel-width');
      localStorage.removeItem('OpenHarness-left-panel-collapsed');
      localStorage.removeItem('OpenHarness-right-panel-collapsed');
