...
export const RemoteConnectDisclaimerContent: React.FC<RemoteConnectDisclaimerContentProps> = ({
  ...
  return (
    <div className="openharness-remote-disclaimer">
      <div className="openharness-remote-disclaimer__meta">
        <Badge variant={agreed ? 'success' : 'warning'}>
          {t(agreed ? 'remoteConnect.disclaimerStatusAgreed' : 'remoteConnect.disclaimerStatusPending')}
        </Badge>
      </div>

      <p className="openharness-remote-disclaimer__text">{t('remoteConnect.disclaimerIntro')}</p>

      <ol className="openharness-remote-disclaimer__list">
      ...
      <div className="openharness-remote-disclaimer__actions">
        <button
          type="button"
          className="openharness-remote-disclaimer__btn openharness-remote-disclaimer__btn--secondary"
          onClick={onClose}
        >
        ...
        {canAgree && (
          <button
            type="button"
            className="openharness-remote-disclaimer__btn openharness-remote-disclaimer__btn--primary"
            onClick={onAgree}
          >
