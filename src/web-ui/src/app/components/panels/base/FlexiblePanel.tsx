...
const FlexiblePanel: React.FC<ExtendedFlexiblePanelProps> = memo(({
  ...
  const renderContent = () => {
    if (!content || content.type === 'empty') {
      return (
        <div className="openharness-flexible-panel__empty-content">
          <div className="openharness-flexible-panel__empty-icon">
    ...
    switch (content.type) {
      case 'code-preview': {
        ...
        return (
          <div className={`openharness-flexible-panel__code-content ${hasFixNeeded ? 'needs-fix' : ''}`}>
      ...
      case 'markdown-viewer':
        return (
          <div className="openharness-flexible-panel__markdown-content">
      ...
      case 'markdown-editor': {
        ...
        return (
          <div className="openharness-flexible-panel__markdown-editor">
            {markdownFilePath || markdownInitialContent !== undefined ? (
              ...
              <div className="openharness-flexible-panel__error-message">
                <AlertCircle size={20} />
      ...
      case 'mermaid-editor': {
        ...
        if (mermaidData.mode || mermaidData.interactive_config || mermaidData.mermaid_code) {
          return (
            <div className="openharness-flexible-panel__mermaid-container">
      ...
      case 'text-viewer':
        return (
          <div className="openharness-flexible-panel__text-content">
      ...
      case 'file-viewer': {
        ...
        const fileViewerClass = `openharness-flexible-panel__panel-code-viewer ${fileNeedsFix ? 'needs-fix' : ''}`;
        
        return (
          <div className="openharness-flexible-panel__code-viewer-container">
            <CodeEditor
      ...
      case 'image-viewer': {
        ...
        return (
          <div className="openharness-flexible-panel__image-viewer-container">
            <ImageViewer
              filePath={imageViewerData.filePath || ''}
              fileName={content.title}
              workspacePath={workspacePath}
              className="openharness-flexible-panel__image-viewer"
            />
          </div>
        );
      }
      ...
      case 'code-viewer': {
        ...
        return (
          <div className="openharness-flexible-panel__code-viewer-container">
            <div className={`openharness-flexible-panel__code-content ${needsFix ? 'needs-fix' : ''}`}>
              <CodeEditor
      ...
      case 'task-detail': {
        ...
        return (
          <React.Suspense fallback={<div className="openharness-flexible-panel__loading">{t('flexiblePanel.loading.taskDetail')}</div>}>
      ...
      case 'plan-viewer': {
        ...
        return (
          <React.Suspense fallback={<div className="openharness-flexible-panel__loading">{t('flexiblePanel.loading.planViewer')}</div>}>
            <PlanViewer
      ...
      case 'terminal': {
        ...
        return (
          <React.Suspense fallback={<div className="openharness-flexible-panel__loading">{t('flexiblePanel.loading.terminal')}</div>}>
            <div className="openharness-flexible-panel__terminal-container">
              <TerminalTabPanel
                key={sessionId}
                sessionId={sessionId}
                autoFocus={true}
      ...
      default:
        return (
          <div className="openharness-flexible-panel__unknown-content">
            <div className="openharness-flexible-panel__unknown-icon">
              <AlertCircle size={48} />
            </div>
            <h3>{t('flexiblePanel.unknownContent.title')}</h3>
            <p>{t('flexiblePanel.unknownContent.description')}</p>
            <div className="openharness-flexible-panel__unknown-meta">
  ...
  return (
    <div className={`openharness-flexible-panel ${className}`}>
      {showHeader && (
        <div className="openharness-flexible-panel__header">
          <div className="openharness-flexible-panel__header-left">
            <div className="openharness-flexible-panel__content-icon">
              {getContentIcon(content.type)}
            </div>
            <div className="openharness-flexible-panel__content-info">
              <span className="openharness-flexible-panel__content-title">
                {content.title || getContentTypeName(content.type)}
              </span>
              <span className="openharness-flexible-panel__content-type">
                {getContentTypeName(content.type)}
              </span>
            </div>
          </div>

          <div className="openharness-flexible-panel__header-right">
      ...
      <div className="openharness-flexible-panel__content">
        {renderContent()}
      </div>
    </div>
  );
