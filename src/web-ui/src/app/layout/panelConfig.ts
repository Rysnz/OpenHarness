...
export const STORAGE_KEYS = {
  LEFT_PANEL_WIDTH: 'openharness:leftPanelWidth',
  RIGHT_PANEL_WIDTH: 'openharness:rightPanelWidth',
  LEFT_PANEL_COLLAPSED: 'openharness:leftPanelCollapsed',
  RIGHT_PANEL_COLLAPSED: 'openharness:rightPanelCollapsed',
  LEFT_PANEL_LAST_WIDTH: 'openharness:leftPanelLastWidth',   // Remembered width before collapse
  RIGHT_PANEL_LAST_WIDTH: 'openharness:rightPanelLastWidth', // Remembered width before collapse
} as const;
