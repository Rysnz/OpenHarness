...
export function getAboutInfo(): AboutInfo {
  ...
  return {
    ...
    license: {
      type: 'MIT',
      text: 'MIT License - Copyright (c) 2025 OpenHarness',
      url: 'https://opensource.org/licenses/MIT'
    },
    links: {
      homepage: 'https://github.com/yourusername/openharness',
      repository: 'https://github.com/yourusername/openharness',
      documentation: 'https://github.com/yourusername/openharness/wiki',
      issues: 'https://github.com/yourusername/openharness/issues'
    }
  };
}
