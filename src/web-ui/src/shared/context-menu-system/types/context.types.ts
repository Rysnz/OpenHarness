...
export type ContextPointerEvent = MouseEvent | ReactMouseEvent;
export type ContextMetadata = Record<string, any>;
export type FlowChatContextPayload = any;
...
export interface FlowChatContext extends BaseContext {
  ...
  dialogTurn?: FlowChatContextPayload;
  modelRound?: FlowChatContextPayload;
  textBlock?: FlowChatContextPayload;
  toolCard?: FlowChatContextPayload;
  userMessage?: FlowChatContextPayload;
  selectedText?: string;
}
