...
/**
 * Custom MIME type for transferring OpenHarness context payloads via the browser DnD API.
 */
export const OPENHARNESS_CONTEXT_MIME_TYPE = 'application/x-openharness-context';
export const OPENHARNESS_CONTEXT_JSON_MIME_TYPE = 'application/json';
