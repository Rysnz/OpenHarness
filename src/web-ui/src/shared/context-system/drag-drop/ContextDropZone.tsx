...
export const ContextDropZone: React.FC<ContextDropZoneProps> = ({
  ...
  return (
    <div
      ref={dropZoneRef}
      className={`
        openharness-context-drop-zone
        ${isDragOver ? 'openharness-context-drop-zone--drag-over' : ''}
        ${canAccept ? 'openharness-context-drop-zone--can-accept' : ''}
        ${!canAccept && isDragOver ? 'openharness-context-drop-zone--cannot-accept' : ''}
        ${className}
      `.trim()}
