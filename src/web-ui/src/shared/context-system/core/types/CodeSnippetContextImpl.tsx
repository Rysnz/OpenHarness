...
export class CodeSnippetCardRenderer implements ContextCardRenderer<'code-snippet'> {
  ...
  render(context: CodeSnippetContext, options?: RenderOptions): React.ReactNode {
    ...
    return (
      <div className={`openharness-context-card openharness-context-card--code-snippet ${compact ? 'openharness-context-card--compact' : ''}`}>
        ...
        <div className="openharness-context-card__content">
          <div className="openharness-context-card__title">
            {context.fileName}
            <span className="openharness-context-card__badge">
          ...
          {!compact && (
            <>
              <div className="openharness-context-card__subtitle">
                {lineCount} {lineCount === 1 ? 'line' : 'lines'}
                {context.language && (
                  <span className="openharness-context-card__meta">
                    {' • '}{context.language}
                  </span>
                )}
              </div>
              ...
              {showPreview && (
                <div className="openharness-context-card__preview">
                  <code className="openharness-context-card__code">
                    {previewText}
                  </code>
                </div>
              )}
        ...
        {interactive && (
          <div className="openharness-context-card__actions">
            <button 
              className="openharness-context-card__action-btn"
