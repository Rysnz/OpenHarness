...
class PlanBuildStateService {
  ...
  private setupGlobalListeners(): void {
    window.addEventListener('openharness:todowrite-update', this.handleTodoWriteUpdate);
    window.addEventListener('openharness:dialog-cancelled', this.handleDialogCancelled);
  }
