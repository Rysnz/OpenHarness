...
const VirtualFileRow = React.memo<VirtualFileRowProps>(({
  ...
  return (
    <div className="openharness-file-explorer__node">
      <FileTreeItem
        node={nodeForIcon}
        level={node.depth}
        indentPx={indentPx}
...
export const VirtualFileTree = forwardRef<VirtuosoHandle, VirtualFileTreeProps>(({
  ...
  if (flatNodes.length === 0) {
    return (
      <div className={`openharness-file-explorer__tree openharness-file-explorer__tree--empty ${className}`}>
        <div className="openharness-file-explorer__empty-message">
  ...
  return (
    <div 
      className={`openharness-file-explorer__tree openharness-file-explorer__tree--virtual ${className}`}
      style={{ height }}
      tabIndex={0}
    >
      <Virtuoso
