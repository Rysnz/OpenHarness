...
const MENU_EVENT_ACTIONS: Array<{ eventName: string; action: EditMenuAction }> = [
  { eventName: 'openharness_menu_edit_undo', action: 'undo' },
  { eventName: 'openharness_menu_edit_redo', action: 'redo' },
  { eventName: 'openharness_menu_edit_cut', action: 'cut' },
  { eventName: 'openharness_menu_edit_copy', action: 'copy' },
  { eventName: 'openharness_menu_edit_paste', action: 'paste' },
  { eventName: 'openharness_menu_edit_select_all', action: 'selectAll' },
];
