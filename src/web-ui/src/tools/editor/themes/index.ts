...
import { OpenHarnessDarkTheme, OpenHarnessDarkThemeMetadata } from './openharness-dark.theme';
...
export function initializeBuiltinThemes(): boolean {
  return registerTheme(OpenHarnessDarkThemeMetadata.id, OpenHarnessDarkTheme);
}

export function ensureDefaultTheme(): void {
  if (!registeredThemes.has(OpenHarnessDarkThemeMetadata.id)) {
    registerTheme(OpenHarnessDarkThemeMetadata.id, OpenHarnessDarkTheme);
  }
}

export function isThemesInitialized(): boolean {
  return registeredThemes.has(OpenHarnessDarkThemeMetadata.id);
}
...
export function getDefaultThemeId(): string {
  return OpenHarnessDarkThemeMetadata.id;
}

export { OpenHarnessDarkTheme, OpenHarnessDarkThemeMetadata };
