/**
 * OpenHarness Dark Theme Definition
 ...
 * - Consistent with OpenHarness UI style
...
/**
 * OpenHarness Dark Theme Configuration
 ...
 */
export const OpenHarnessDarkTheme: editor.IStandaloneThemeData = {
  base: 'vs-dark',
  inherit: true,
...
export const OpenHarnessDarkThemeMetadata = {
  id: 'openharness-dark',
  label: 'Dark',
