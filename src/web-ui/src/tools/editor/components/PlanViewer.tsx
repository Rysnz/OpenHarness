...
${JSON.stringify(simpleTodos, null, 2)}
  ...
  if (loading) {
    return (
      <div className="openharness-plan-viewer openharness-plan-viewer--loading">
        <OpenHarnessLoading size="medium" text={t('editor.planViewer.loadingPlan')} />
      </div>
    );
  }
  ...
  if (error) {
    return (
      <div className="openharness-plan-viewer openharness-plan-viewer--error">
  ...
  return (
    <div className="openharness-plan-viewer">
      <div
