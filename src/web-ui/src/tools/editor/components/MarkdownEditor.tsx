...
const MarkdownEditor: React.FC<MarkdownEditorProps> = ({
  ...
  if (loading) {
    return (
      <div className={`openharness-markdown-editor-loading ${className}`}>
        <OpenHarnessLoading size="medium" text={t('editor.markdownEditor.loadingFile')} />
      </div>
    );
  }
  ...
  if (error) {
    return (
      <div className={`openharness-markdown-editor-error ${className}`}>
  ...
  if (shouldUseSourcePreviewFallback) {
    return (
      <div className={`openharness-markdown-editor ${className}`}>
        {notices.length > 0 && (
          <div className="openharness-markdown-editor__notice-bar">
            <AlertCircle className="openharness-markdown-editor__notice-icon" />
            <div className="openharness-markdown-editor__notice-copy">
              {notices.map(notice => (
        ...
        <div className="openharness-markdown-editor__mode-toolbar">
          <div className="openharness-markdown-editor__mode-toggle" role="tablist" aria-label={t('editor.markdownEditor.viewModeLabel')}>
            <Button
              type="button"
              size="small"
        ...
        <div className="openharness-markdown-editor__unsafe-body">
