...
export const CreateBranchDialog: React.FC<CreateBranchDialogProps> = ({
  ...
  return (
    <Modal isOpen={isOpen} onClose={handleCancel} title={t('dialog.createNewBranch.title')} size="small">
      <div className="openharness-create-branch-dialog" onKeyDown={handleKeyDown}>
        <div className="openharness-create-branch-dialog__base-info">
          <div className="openharness-create-branch-dialog__base-label">
            <GitBranch size={14} />
            <span>{t('dialog.createNewBranch.baseBranch')}</span>
          </div>
          <div className="openharness-create-branch-dialog__base-value">
            {baseBranch}
          </div>
        </div>

        <div className="openharness-create-branch-dialog__form">
          <Input
            ...
            errorMessage={error}
          />
          <div className="openharness-create-branch-dialog__hint">
        ...
        <div className="openharness-create-branch-dialog__actions">
          <Button 
            variant="secondary"
            size="small"
        ...
        <div className="openharness-create-branch-dialog__shortcuts">
