...
const ConnectedTerminal: React.FC<ConnectedTerminalProps> = memo(({
  ...
  if (isLoading) {
    return (
      <div className={`openharness-terminal ${className}`}>
        <div className="openharness-terminal__loading">
          <div className="openharness-terminal__loading-spinner" />
          <span className="openharness-terminal__loading-text">Connecting to terminal...</span>
        </div>
      </div>
    );
  }
  ...
  if (error) {
    return (
      <div className={`openharness-terminal ${className}`}>
        <div className="openharness-terminal__error">
          <AlertCircle className="openharness-terminal__error-icon" size={32} />
          <span className="openharness-terminal__error-message">{error}</span>
          <button 
            className="openharness-terminal__error-retry"
            onClick={handleRetry}
          >
            <RefreshCw size={14} />
            <span>Retry</span>
  ...
  return (
    <div className={`openharness-terminal ${className}`}>
      {showToolbar && (
        <div className="openharness-terminal__toolbar">
          <div className="openharness-terminal__toolbar-left">
            <TerminalIcon size={14} />
            <span className="openharness-terminal__toolbar-title">
              {title}
              {session && (
          ...
          <div className="openharness-terminal__toolbar-right">
            <button
              className="openharness-terminal__toolbar-btn"
            ...
            <button
              className="openharness-terminal__toolbar-btn openharness-terminal__toolbar-btn--danger"
              onClick={handleClose}
      ...
      {showStatusBar && session && (
        <div className={`openharness-terminal__statusbar ${
          isExited ? 'openharness-terminal__statusbar--exited' : ''
        } ${
          error ? 'openharness-terminal__statusbar--error' : ''
        }`}>
          <div className="openharness-terminal__statusbar-left">
            <span className="openharness-terminal__statusbar-item">
              {session.shellType}
            </span>
            <span className="openharness-terminal__statusbar-item">
              PID: {session.pid || '-'}
          ...
          <div className="openharness-terminal__statusbar-right">
            <span className="openharness-terminal__statusbar-item">
