/**
 * OpenHarness pixel panda — 32×32, white halo + ear rims for dark UI,
...
function HeadHalo() {
  const cls = 'openharness-panda__halo';
  return (
    <g className="openharness-panda-head__halo">
...
function HeadDisk() {
  const cls = 'openharness-panda__w';
  return (
    <g className="openharness-panda-head__disk">
...
function EarRims() {
  const cls = 'openharness-panda__halo';
  return (
    <g className="openharness-panda-head__ear-rims" aria-hidden>
...
function Ears() {
  const b = 'openharness-panda__b';
  return (
    <g className="openharness-panda-head__ears" aria-hidden>
...
function EyePatches() {
  const b = 'openharness-panda__b';
  return (
    <g className="openharness-panda-head__patches" aria-hidden>
...
function Nose() {
  const b = 'openharness-panda__b';
  return (
    <g className="openharness-panda-head__nose" aria-hidden>
...
function EyesOpen() {
  const hi = 'openharness-panda__eye-hi';
  const pu = 'openharness-panda__pupil';
  return (
    <g className="openharness-panda-head__eyes-open" aria-hidden>
...
function FaceRest() {
  const hi = 'openharness-panda__eye-hi';
  return (
    <g className="openharness-panda-head__face openharness-panda-head__face--rest">
...
function FaceAnalyzing() {
  return (
    <g className="openharness-panda-head__face openharness-panda-head__face--analyze">
      <EyesOpen />
      <Nose />
      <g className="openharness-panda-head__dots" aria-hidden>
        <Px x={2} y={6} w={2} h={2} className="openharness-panda-head__dot" />
        <Px x={28} y={4} w={2} h={2} className="openharness-panda-head__dot" />
        <Px x={15} y={1} w={2} h={2} className="openharness-panda-head__dot" />
      </g>
    </g>
  );
}
...
function FaceWaiting() {
  return (
    <g className="openharness-panda-head__face openharness-panda-head__face--wait">
      <EyesOpen />
      <Nose />
      <g className="openharness-panda-head__wait-pips" aria-hidden>
        <Px x={10} y={27} w={2} h={2} className="openharness-panda-head__wait-pip" />
        <Px x={15} y={27} w={2} h={2} className="openharness-panda-head__wait-pip" />
        <Px x={20} y={27} w={2} h={2} className="openharness-panda-head__wait-pip" />
      </g>
    </g>
  );
}
...
function FaceWorking() {
  return (
    <g className="openharness-panda-head__face openharness-panda-head__face--work">
      <EyesOpen />
      <Nose />
      <g className="openharness-panda-head__sweat" aria-hidden>
        <Px x={4} y={8} w={2} h={2} className="openharness-panda-head__sweat-drop" />
        <Px x={26} y={7} w={2} h={2} className="openharness-panda-head__sweat-drop" />
      </g>
      <g className="openharness-panda-head__speed" aria-hidden>
        <Px x={0} y={10} w={2} h={2} className="openharness-panda-head__speed-line" />
        <Px x={0} y={14} w={2} h={2} className="openharness-panda-head__speed-line" />
        <Px x={0} y={18} w={2} h={2} className="openharness-panda-head__speed-line" />
        <Px x={30} y={10} w={2} h={2} className="openharness-panda-head__speed-line" />
        <Px x={30} y={14} w={2} h={2} className="openharness-panda-head__speed-line" />
        <Px x={30} y={18} w={2} h={2} className="openharness-panda-head__speed-line" />
      </g>
    </g>
  );
}
...
function MoodSvg({ mood }: { mood: ChatInputPetMood }) {
  const rootClass = `openharness-panda-head openharness-panda-head--${mood}`;
