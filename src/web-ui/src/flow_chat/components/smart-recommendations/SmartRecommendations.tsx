...
export const SmartRecommendations: React.FC<SmartRecommendationsProps> = ({
  ...
  return (
    <div className={`openharness-smart-recommendations ${className}`}>
      <div className="openharness-smart-recommendations__header">
        <span className="openharness-smart-recommendations__title">{t('smartRecommendations.title')}</span>
        <Tooltip content={t('smartRecommendations.close')}>
          <button
            className="openharness-smart-recommendations__close"
            onClick={handleClose}
          >
            <X size={16} />
          </button>
      ...
      <div className="openharness-smart-recommendations__actions">
        {actions.map(action => {
          ...
          return (
            <button
              key={action.id}
              className={`openharness-smart-recommendations__action openharness-smart-recommendations__action--${action.type || 'secondary'}`}
            ...
            >
              ...
              {isLoading && <span className="openharness-smart-recommendations__loading">...</span>}
            </button>
          );
        })}
      </div>
