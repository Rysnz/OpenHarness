...
export const CoworkExampleCards: React.FC<CoworkExampleCardsProps> = ({
  ...
  const cards = useMemo(() => {
    return selected.map((example) => {
      ...
      return (
        <Card
          key={example.id}
          className="openharness-cowork-example-cards__card"
          variant="subtle"
          interactive
          onClick={() => onSelectPrompt(prompt)}
        >
          <div className="openharness-cowork-example-cards__card-header">
            <div className="openharness-cowork-example-cards__card-icon">
              <Icon size={18} />
            </div>
            <div className="openharness-cowork-example-cards__card-title">{title}</div>
          </div>
          <div className="openharness-cowork-example-cards__card-desc">{description}</div>
        </Card>
      );
    });
  ...
  return (
    <div className="openharness-cowork-example-cards">
      <div className="openharness-cowork-example-cards__header">
        <div className="openharness-cowork-example-cards__title">{t('coworkExamples.title')}</div>
        <div className="openharness-cowork-example-cards__header-actions">
          {onAddPlugin && (
      ...
      <div className="openharness-cowork-example-cards__grid">
        {cards}
      </div>
    </div>
  );
