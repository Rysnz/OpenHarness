...
export const Tooltip: React.FC<TooltipProps> = ({
  ...
  const tooltipClass = [
    'openharness-tooltip',
    `openharness-tooltip--${actualPlacement}`,
    visible && positionReady && 'openharness-tooltip--visible',
    interactive && 'openharness-tooltip--interactive',
    className
  ].filter(Boolean).join(' ');
  ...
  return (
    <>
      ...
      {visible && createPortal(
        ...
        >
          <div className="openharness-tooltip__content">{content}</div>
        </div>,
        document.body
      )}
    </>
