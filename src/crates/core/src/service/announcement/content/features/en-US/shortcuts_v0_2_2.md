...
OpenHarness ships with a complete shortcut system covering panel toggles, scene switching, editor operations and more.
...
**Tip:** If the new shortcut conflicts with an existing binding, OpenHarness will warn you and ask whether to overwrite.
