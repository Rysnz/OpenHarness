...
impl BaselineCache {
    ...
    pub fn new(openharness_dir: &Path) -> Self {
        let baseline_dir = openharness_dir.join("snapshots").join("baselines");
...
impl FileSnapshotSystem {
    ...
    pub fn new(openharness_dir: &Path) -> Self {
        let snapshot_dir = openharness_dir.join("snapshots");
        ...
        Self {
            ...
            dedup_enabled: true,
            baseline_cache: BaselineCache::new(openharness_dir),
        }
    }
