...
impl Tool for WrappedTool {
    ...
    async fn description(&self) -> crate::util::errors::OpenHarnessResult<String> {
    ...
    ) -> crate::util::errors::OpenHarnessResult<Vec<ToolResult>> {
...
impl WrappedTool {
    ...
    async fn handle_file_modification_internal(
        ...
        let session_id = context.session_id.clone().ok_or_else(|| {
            crate::util::errors::OpenHarnessError::Tool(
        ...
        let raw_path = match self.extract_file_path_simple(input) {
            Ok(path) => path,
            Err(e) => return Err(crate::util::errors::OpenHarnessError::Tool(e.to_string())),
        };
        ...
        let snapshot_manager = get_or_create_snapshot_manager(snapshot_workspace.clone(), None)
            .await
            .map_err(|e| crate::util::errors::OpenHarnessError::Tool(e.to_string()))?;
            ...
            && !is_create_tool
        {
            ...
            return Err(crate::util::errors::OpenHarnessError::Tool(format!(
