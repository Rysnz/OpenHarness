...
impl WorkspaceProvider {
    ...
    pub async fn open(&self, path: &str) -> OpenHarnessResult<WorkspaceInfo> {
    ...
    pub async fn switch(&self, workspace_id: &str) -> OpenHarnessResult<()> {
    ...
    pub async fn close_current(&self) -> OpenHarnessResult<()> {
    ...
    /// Quick cleanup.
    pub async fn quick_cleanup(&self) -> OpenHarnessResult<WorkspaceCleanupResult> {
    ...
    pub async fn detect_project_type(&self, path: &str) -> OpenHarnessResult<WorkspaceType> {
        let path_buf = PathBuf::from(path);

        if !path_buf.exists() {
            return Err(OpenHarnessError::service("Path does not exist".to_string()));
        }
    ...
    pub async fn get_file_stats(
        &self,
        workspace_id: &str,
    ) -> OpenHarnessResult<Option<WorkspaceStatistics>> {
    ...
    /// Rescans a workspace.
    pub async fn rescan(&self, workspace_id: &str) -> OpenHarnessResult<WorkspaceInfo> {
