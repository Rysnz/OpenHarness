...
mod tests {
    ...
    fn stream_output_delta_returns_utf8_suffix_without_cutting_chars() {
        let mut last_sent_output = "你好！我是 OpenHarness，".to_string();
        let output = "你好！我是 OpenHarness，可以帮助你完成软件工程任务。".to_string();
    ...
    fn stream_output_delta_resets_when_previous_snapshot_is_not_prefix() {
        ...
        let output = "你好！我是 OpenHarness，可以帮助你完成软件工程任务。有什么我可以帮你的吗？";
