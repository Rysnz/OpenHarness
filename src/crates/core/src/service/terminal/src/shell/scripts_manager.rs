...
impl ScriptsManager {
    ...
    /// - Linux: `~/.cache/openharness_terminal/scripts/`
    /// - Windows: `%LOCALAPPDATA%\openharness_terminal\scripts\`
    /// - macOS: `~/Library/Caches/openharness_terminal/scripts/`
