...
use crate::wire::gemini::GeminiSSEData;
use crate::wire::unified::UnifiedResponse;
...
impl GeminiToolCallState {
    ...
    fn assign_id(&mut self, tool_call: &mut crate::wire::unified::UnifiedToolCall) {
...
mod tests {
    ...
    use crate::wire::unified::UnifiedToolCall;
