...
mod tests {
    ...
    fn resolves_gemini_request_url_bare_host() {
        assert_eq!(
            resolve_request_url("https://api.openopenharness.com", "gemini", "gemini-2.5-pro"),
            "https://api.openopenharness.com/v1beta/models/gemini-2.5-pro:streamGenerateContent?alt=sse"
        );
    }
