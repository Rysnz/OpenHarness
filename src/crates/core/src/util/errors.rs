...
/// Unified error type for the OpenHarness application
#[derive(Debug, Error, Serialize)]
pub enum OpenHarnessError {
...
pub type OpenHarnessResult<T> = Result<T, OpenHarnessError>;
...
impl From<OpenHarnessError> for String {
    fn from(err: OpenHarnessError) -> String {
        err.to_string()
    }
}

impl From<String> for OpenHarnessError {
    fn from(error: String) -> Self {
        OpenHarnessError::Service(error)
    }
}

impl From<&str> for OpenHarnessError {
    fn from(error: &str) -> Self {
        OpenHarnessError::Service(error.to_string())
    }
}

impl From<tokio::sync::AcquireError> for OpenHarnessError {
    fn from(error: tokio::sync::AcquireError) -> Self {
        OpenHarnessError::Semaphore(error.to_string())
    }
}
