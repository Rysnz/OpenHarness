...
mod tests {
    ...
    fn test_cursor_forward() {
        ...
        let input = "d----           2026/1/10\x1b[16C.openharness";
        // "d----           2026/1/10" is 22 chars, cursor moves from col 22 to col 22+16=38
        // Since 38 > 22, spaces are padded to reach col 38, then ".openharness" is appended
        assert_eq!(
            strip_ansi(input),
            "d----           2026/1/10                .openharness"
        );
    }
