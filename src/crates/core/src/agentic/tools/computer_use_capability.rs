//! Desktop-only gate for Computer use (set from OpenHarness desktop at startup).

use std::sync::atomic::{AtomicBool, Ordering};

static COMPUTER_USE_DESKTOP_AVAILABLE: AtomicBool = AtomicBool::new(false);

/// Mark whether this process is OpenHarness desktop with OS automation wired up.
