...
impl HtmlLabels {
    ...
    pub fn en() -> Self {
        HtmlLabels {
            ...
            nav_usage: "How You Use OpenHarness",
            ...
            section_usage: "How You Use OpenHarness",
            ...
            md_additions: "OPENHARNESS.md Additions",
    ...
    pub fn zh() -> Self {
        HtmlLabels {
            ...
            section_work: "工作领域",
            section_usage: "你如何使用 OpenHarness",
            section_wins: "亮眼成果",
            ...
            md_additions: "OPENHARNESS.md 补充",
...
fn render_suggestions(suggestions: &InsightsSuggestions, l: &HtmlLabels) -> String {
    ...
    if !suggestions.openharness_md_additions.is_empty() {
