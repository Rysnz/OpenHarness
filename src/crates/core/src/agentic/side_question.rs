...
impl SideQuestionService {
    ...
    ) -> OpenHarnessResult<Vec<CoreMessage>> {
...
- Reply concisely, matching the question's language.\n"
    ...
    pub async fn ask(
        ...
        let client = self
            ...
            .await
            .map_err(|e| OpenHarnessError::service(format!("Failed to create AI client: {}", e)))?;
    ...
    ) -> OpenHarnessResult<mpsc::UnboundedReceiver<SideQuestionStreamEvent>> {
